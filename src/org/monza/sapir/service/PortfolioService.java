...
public class PortfolioService {
	 ...
	 */
	public void update() {
		StockStatus[] stocks = getPortfolio().getStock();
		List<String> symbols = new ArrayList<>(Portfolio.MAX_PROTFOLIO_SIZE);
		for (StockStatus stockStatus : stocks) {
			symbols.add(stockStatus.getsymbol());
		}
		
		List<StockStatus> update = new ArrayList<>(Portfolio.MAX_PROTFOLIO_SIZE);
